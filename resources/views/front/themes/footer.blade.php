        ...
        <div class="container">
          <div class="footer-columns">
            ...
            <div class="col-md-4 mb-4 mb-md-0 d-flex d-md-block flex-column align-items-center text-center text-md-left ">
              <div class="info_info">
                <div class="footer-tagline accent">Memberikan Solusi Digital untuk Masa Depan Bisnis Anda</div>
              </div>
            </div>
            ...
            <div class="col-md-4 mb-4 mb-md-0 d-flex d-md-block flex-column align-items-center text-center text-md-left ">
              <div class="info_contact">
                <h5>Tentang Kami</h5>
                <div>
                  <div class="img-box"><img src="{{ asset('assets/images/location-white.png') }}" width="18px" alt=""></div>
                  <p>Mojokerto, Jawa Timur</p>
                </div>
                <div>
                  <div class="img-box"><img src="{{ asset('assets/images/telephone-white.png') }}" width="12px" alt=""></div>
                  <p>+62 813 3452 3020</p>
                </div>
                <div>
                  <div class="img-box"><img src="{{ asset('assets/images/envelope-white.png') }}" width="18px" alt=""></div>
                  <p>oktavianfaisal97@gmail.com</p>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7 col-md-9 mx-auto">
              <p>Copyright &copy; {{ date('Y') }} <a href="http://faio.my.id/" target="_blank">Faisal Oktavian</a></p>
            </div>
          </div>
        </div>
      </section>
